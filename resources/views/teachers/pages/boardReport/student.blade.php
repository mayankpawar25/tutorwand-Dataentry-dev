        ...
        <div class="canvas-body">
            <div class="top-cards">
                <div class="row g-2">
                    ...
                    <div class="col-md-3 text-center">
                        <div class="well global-profile">
                            <div class="student-icon-card">
                                @if(isset($performance['profileUrl']) && !empty($performance['profileUrl']))
                                <img src="{!! handleProfilePic($performance['profileUrl']) !!}">
                                @else
                                <img src="{{ asset('assets/images/teachers/user-icon.jpg') }}">
                                @endif
                            </div>
                            <div class="global-profile-meta ml-4">
                                <h5 class="mt-2 mb-0"> {{ isset($performance['studentName']) && !empty($performance['studentName']) ? $performance['studentName'] : 'Student Name' }} </h5>
                                <h5 class="mb-0">{{ __('teachers.report.board') }}: {{ $performance['board']['boardName'] }} | {{ __('teachers.assessment.grade') }}: {{ $performance['grade']['gradeName'] }}</h5>
                                <h5 class="mb-0">{{ __('teachers.assessment.subject') }}: {{ $performance['subject']['subjectName'] }}</h5>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="well global-point-card pt-4 pb-3 ">
                        ...
                        <div class="well circle-card">
                            <div class="progressbar">
                                <div class="second circle" data-percent="{{ ($performance['optainedMark']*100)/ $performance['maximumMark'] }}">
                                    <strong></strong>
                                    <span>{{ __('teachers.report.classAverage') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="well circle-card">
                            <div class="progressbar">
                                <div class="second circle" data-percent="{{ ($performance['globalAverage']*100)/ $performance['maximumMark'] }}">
                                    <strong></strong>
                                    <span>{{ __('teachers.report.globalClassAverage') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="well global-rank-card pt-3 pb-3">
                        <div class="row">
                            <div class="col-sm-6 bdr-right">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <div class="icon">
                                            {!! config('constants.icons.rank-icon') !!}</div>
                                        <h5 class="ml-2 mb-0">{{ __('teachers.report.rank') }}</h5>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <h3> {{ $performance['rank'] }}
                                            <font>/{{ $performance['attemptedStudentCount'] }}</font>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div>
                                        <h5 class="mb-0">{{ __('teachers.report.globalRank') }} </h5>
                                    </div>
                                    <div>
                                        <h3> {{ $performance['globalRank'] }}
                                            <font>/{{ $performance['globalAttemptedStudentCount'] }}</font>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 bdr-right">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h5 class="ml-2 mb-0">Time spend <br>
                                            <small>Minutes</small>
                                        </h5>
                                    </div>
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center justify-content-between mw-100">
                                    <div>
                                        <h5 class="mb-0">Global Average </h5>
                                    </div>
                                    <div>
