<div class="right-panel-section">
    <div class="well">
        <div class="form-group">
            ...
            <x-forms.input type="text" class="form-control input-regular onchangeValue" placeholder="{{ __('questionLayout.assessmentName') }}" id="input-form" name="input_title" value="{{ (isset($session['inputTitle'])) ? $session['inputTitle'] : '' }}" maxlength="30"/>
