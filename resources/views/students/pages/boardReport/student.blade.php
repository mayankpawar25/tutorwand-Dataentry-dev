                        ...
                        <div class="well circle-card">
                            <div class="progressbar">
                                <div class="second circle" data-percent="{{ ($performance['globalAverage']*100)/ $performance['maximumMark'] }}">
                                    <strong></strong>
                                    <span>Global {{ __('teachers.report.average') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function topicGraph(chunkId) {
        ...
        while (labels.length > 0) {
            ...
            globalAverageData.push(globalAverageData.splice(0, chunkSize));
        ...
        const data = {
            ...
            datasets: [{
                    ...
                    data: globalAverageData[chunkId],
                    borderColor: '#d0ae5e',
