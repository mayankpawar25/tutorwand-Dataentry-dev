...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/materialize/css/materialize.min.css') }}">



<!-- common CSS Files -->

<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/stylematerial.css') }}">
...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/malihu-custom-scrollbar/jquery.mCustomScrollbar.css') }}"/>

<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/toastr/toastr.min.css') }}">

<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/monthly/monthly.css') }}"/>

<link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/simplebar/dist/simplebar.css') }}"/>
...
<link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/dist/css/custom.css') }}">
