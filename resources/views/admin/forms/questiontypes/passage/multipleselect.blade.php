<div class="accordion" data-type="{{$questionType}}" data-id={{$sno}}>
    <div class="card" >
        <div class="card-header" data-toggle="collapse" data-target="#collapse{{$sno}}" aria-expanded="true">     
            <span class="title"><span id="sequence">{{$sno+1}}</span>. <span class="title-content">Multi select </span></span>
                ...
                @php
                    ...
                    @endphp
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="well2">
                                            <input tabindex="1" type="checkbox" id="passage-checkbox-mcs{{$index+1}}-{{$sno}}" name="passage-checkbox-mcs-{{$sno}}" {{$option["isCorrect"] ? "checked" : ""}}>
                                            <label for="passage-checkbox-mcs{{$index+1}}-{{$sno}}">Select correct option {{$index+1}}</label>
                                            @if($index > 2)
                                            <a class="removePassageCheckboxOption float-right" data-rowid="passage-option{{$index+1}}-{{$sno}}">
                    ...
                    @endphp
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input tabindex="1" type="checkbox" id="passage-checkbox-mcs1-{{$sno}}" name="passageanswer1" value="1"/>

                                <label for="passage-checkbox-mcs1-{{$sno}}">Select correct option 1</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="well2">
                                <input tabindex="1" type="checkbox" id="passage-checkbox-mcs2-{{$sno}}" name="passageanswer2" value="2"/>
                                <label for="passage-checkbox-mcs2-{{$sno}}">Select correct option 2</label>
                                <div class="form-group">
                                    <div class="">
                                        <textarea class="form-control passage_options" placeholder="Option 2" name="passage_option1[]" id="passage-option2-{{$sno}}" data-color="dddddd"></textarea>
                                    </div>
                                    <div class="passage-option1-error error"></div>
                                </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="well2">
                                ...
                                <input tabindex="1" type="checkbox" id="passage-checkbox-mcs3-{{$sno}}" name="passageanswer3" value="3">

                                <label for="passage-checkbox-mcs3-{{$sno}}">Select correct option 3</label>
