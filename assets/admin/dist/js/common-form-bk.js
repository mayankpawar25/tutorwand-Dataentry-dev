"use strict";
    ...
    //previous year tag
    $(`input[name="year1"]`).amsifySuggestags({
        suggestions: ["2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"],
        whiteList: true
    });

    //previous year tag
    $(`input[name="year2"]`).amsifySuggestags({
        suggestions: ["2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"],
        whiteList: true
    });

    //previous year tag
    $(`input[name="year3"]`).amsifySuggestags({
        suggestions: ["2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"],
        whiteList: true
    });

    //previous year tag
    $(`input[name="year4"]`).amsifySuggestags({
        suggestions: ["2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"],
        whiteList: true
    });

    //previous year tag
    $(`input[name="year5"]`).amsifySuggestags({
        suggestions: ["2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014", "2015", "2016", "2017", "2018", "2019", "2020"],
        whiteList: true
    });
 ...
 */
function setQuestionFormat(questionTitle, answerTitle, hintTitle, extendedSolitionTitle, yearsTitle, optionData){
...
$(document).on("click",".submitButton", function(){
    ...
    if(submitError) {
        var jsonData = setQuestionFormat(questionTitle, answerTitle,  hintTitle, extendedSolitionTitle, yearsTitle, optionData);
        ajaxSubmit(jsonData);
    }
});
