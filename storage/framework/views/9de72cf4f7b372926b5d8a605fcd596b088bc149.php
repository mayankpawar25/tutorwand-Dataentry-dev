        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <?php else: ?>
                    ...
                    <input type="hidden" class="questionNumber" value="<?php echo e($questionNumber); ?>">


                    <input type="hidden" class="creatorId" id="creatorId" value="<?php echo e($question['creatorId']); ?>">
                                                ...
                                                <?php if(isset($s_options) && !empty($s_options)): ?>
                                                    <?php $__currentLoopData = $s_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="well2">
                                                                <input tabindex="1" type="radio" id="flat-radio-mcq<?php echo e($i+1); ?>" name="flat-radio<?php echo e($i + 1); ?>" <?php echo e(($option['isCorrect']) ? "checked" : ""); ?>>
                                        ...
                                        <?php if(!empty($question)): ?>
                                            <div class="select_area">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <p><strong><?php echo e(__('admin.dateNTimeLabel')); ?>:</strong> <?php echo e(localTimeZone($question['creationTimeStamp'])); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                                <hr>
...
<?php $__env->startSection('onPageJs'); ?>
    ...
    <?php echo $__env->make('admin.layout.partials.reviewScript', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>


    <script type="text/javascript" src="<?php echo e(asset('assets/admin/dist/js/review-form.js')); ?>"></script>


    <script type="text/javascript" src="<?php echo e(asset('assets/plugins/mathjax/tex-mml-chtml.js')); ?>"></script>


<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/abhyur2a/public_html/tutorwand.com/dataentry-dev/resources/views/admin/review/question.blade.php ENDPATH**/ ?>