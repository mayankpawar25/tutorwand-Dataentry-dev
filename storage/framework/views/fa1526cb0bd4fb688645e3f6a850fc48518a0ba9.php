    <form action="" method="post" id="multi-select-form" data-type="<?php echo e($questionType); ?>" class="accordion">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="">
                            <textarea class="form-control" name="passage_question[]" id="multiple-select-question" placeholder="Question" rows="2" data-color="cbf9db"><?php echo e(isset($questionText) ? $questionText : ''); ?></textarea>
                        </div>
            ...
            <?php
                ...
                ?>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="well2">
                                        <input tabindex="1" type="checkbox" id="passage-checkbox-mcs<?php echo e($index+1); ?>" name="passage-checkbox-mcs" <?php echo e($option["isCorrect"] ? "checked" : ""); ?>>
                                        <label for="passage-checkbox-mcs<?php echo e($index+1); ?>">Select correct option <?php echo e($index+1); ?></label>
                                        <?php if($index > 2): ?>
                                        <a class="removePassageCheckboxOption float-right" data-rowid="passage-option<?php echo e($index+1); ?>">
                                            <i class="material-icons text-danger">delete</i>
                                        </a>
                                        <?php endif; ?>
                                        <div class="form-group">
                                            <div class="">
                                                <textarea class="form-control passage_options" placeholder="Option <?php echo e($index+1); ?>" name="passage_option1[]" id="passage-option<?php echo e($index+1); ?>" data-color="dddddd"><?php echo e($option["optionText"]); ?></textarea>
                                            </div>
                ...
                <a href="javascript:void(0)" data-id="<?php echo e($sno); ?>" class="link addNewCheckboxOption">Add more options</a>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" id="passage-extendedsolution" name="passage_extend_solution[]" placeholder="Extended Solution" data-color="fff2d9"><?php echo e(isset($answerBlock['extendedSolution']) && !empty($answerBlock['extendedSolution']) ? $answerBlock['extendedSolution'] : ''); ?></textarea>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <textarea id="msq-hint" class="form-control" placeholder="Hint" data-color="c9e1ff"><?php echo e(isset($answerBlock['hint']) && !empty($answerBlock['hint']) ? $answerBlock['hint'] : ''); ?></textarea> 
                    </div>
                </div>
            </div><!-- Hint solns -->
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <input type="text" name="msq_year" class="form-control" placeholder="Appeared in Previous Year Exams:" value="<?php echo e(isset($askedYears) ? implode(',', $askedYears) : ''); ?>">
                    </div>
                </div>
...
</form><?php /**PATH /home1/abhyur2a/public_html/tutorwand.com/dataentry-dev/resources/views/admin/forms/questiontypes/multipleselect.blade.php ENDPATH**/ ?>