                ...
                <?php
                    ...
                    ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="well2">
                                            <input tabindex="1" type="checkbox" id="passage-checkbox-mcs<?php echo e($index+1); ?>-<?php echo e($sno); ?>" name="passage-checkbox-mcs-<?php echo e($sno); ?>" <?php echo e($option["isCorrect"] ? "checked" : ""); ?>>
                                            <label for="passage-checkbox-mcs<?php echo e($index+1); ?>-<?php echo e($sno); ?>">Select correct option <?php echo e($index+1); ?></label>
                                            <?php if($index > 2): ?>
                                            <a class="removePassageCheckboxOption float-right" data-rowid="passage-option<?php echo e($index+1); ?>-<?php echo e($sno); ?>">
                    ...
                    ?>
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <input tabindex="1" type="checkbox" id="passage-checkbox-mcs1-<?php echo e($sno); ?>" name="passageanswer1" value="1"/>

                                <label for="passage-checkbox-mcs1-<?php echo e($sno); ?>">Select correct option 1</label>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="well2">
                                <input tabindex="1" type="checkbox" id="passage-checkbox-mcs2-<?php echo e($sno); ?>" name="passageanswer2" value="2"/>
                                <label for="passage-checkbox-mcs2-<?php echo e($sno); ?>">Select correct option 2</label>
                                <div class="form-group">
                                    <div class="">
                        ...
                        <div class="row">
                            ...
                            <div class="well2">
                                ...
                                <input tabindex="1" type="checkbox" id="passage-checkbox-mcs3-<?php echo e($sno); ?>" name="passageanswer3" value="3">

                                <label for="passage-checkbox-mcs3-<?php echo e($sno); ?>">Select correct option 3</label>
...
<?php /**PATH /home1/abhyur2a/public_html/tutorwand.com/dataentry-dev/resources/views/admin/forms/questiontypes/passage/multipleselect.blade.php ENDPATH**/ ?>