            ...
            <?php $__currentLoopData = $question['answerBlock']['options']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="custom-control custom-radio">
                    ...
                    <?php if($option['isCorrect']): ?>
                        <?php $resp = 'checked'; ?>
                    <?php endif; ?>
                    <input type="radio" id="customRadio1-<?php echo e($questionNumber); ?>-<?php echo e($index); ?>" name="customRadio<?php echo e($questionNumber); ?><?php echo e($index); ?>" class="custom-control-input" <?php echo e($resp); ?> disabled/>
...
</div><?php /**PATH /home1/abhyur2a/public_html/tutorwand.com/dataentry-dev/resources/views/admin/review/question-type-question-answers/multiple-blanks.blade.php ENDPATH**/ ?>